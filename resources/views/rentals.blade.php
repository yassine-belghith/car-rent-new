...
<section class="rentals p-5">
    <div class="container mt-5">
        <div class="mb-3 position-relative d-flex justify-content-between w-100">
            <h3>Mes Location</h3>
            <input type="text" id="search" class="form-control w-50 mx-3" placeholder="Rechercher..." onkeyup="filterRentals()">
            <button class="btn btn-primary w-25" onclick="filterRentals();return false;">Rechercher</button>
        </div>
        <div class="d-flex flex-wrap mt-5" id="rentalsContainer">
...
function filterRentals(){
  ...
  const cards=document.querySelectorAll('#rentalsContainer .row');
  cards.forEach(card=>{
